...
<div class="w3-top">
  ...
  <div class="w3-dropdown-hover">
    ...
    <div class="w3-dropdown-content w3-bar-block w3-border">
       ...
       <a href="admintasklist.php"  class="w3-bar-item w3-button"> My Task List</a>
       
        <a href="tasklist.php"  class="w3-bar-item w3-button"> All users task</a>
  ...
  <div class="w3-dropdown-hover">
    <button class="w3-button w3-light-grey">Users</button>
    <div class="w3-dropdown-content w3-bar-block w3-border">

     
      
        <a href="registers.php"  class="w3-bar-item w3-button"> Add New User</a>
        <a href="userslist.php"  class="w3-bar-item w3-button"> User List</a>
