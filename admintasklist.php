...
if($_SESSION['id'] != '1')
{
    ...
    include 'config.php';
     $query = "SELECT * FROM task WHERE user = '" . $row['name'] . "'  ";
...
<head>
  ...
  <title><?php echo ucwords($row['name']); ?> Task List </title>
...
<div style="text-align: center;">
   <body class="container">
    <h1><?php echo ucwords($row['name']); ?> Todo List</h1>
                ...
                <td align='center' >" . $sta ."</td>
                                    ...
                                    <td align='center'>
                                        <a class='btn btn-xs btn-info'  
                                            href='adminupdate.php?no=" . $tid . "'title=UPDATE>
                                            <img src='images/edit.png'  style='width:20px;height:20px;'></a>
</td>

   <td align='center'>
                                      <a onclick=\"return confirm('Are you sure?')\" href=\"admindelete.php?no=" . $tid ."\" title=REMOVE><img src='delete.png'  style='width:20px;height:20px;'></a>
</td>
